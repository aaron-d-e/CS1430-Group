...
public:
    ...
    //              Initializes the object with no music and default
    //              volume level.
    // return: None
    // pre: None
    // post: A backgroundMusic object is created with no music loaded.
    //************************************************************
    backgroundMusic();

    //************************************************************
    // description: Constructor that loads a song from the given path
    //              and sets the initial volume.
    // return: None
    // pre: The file at the provided path must exist and be a valid
    //      music file.
    // post: A backgroundMusic object is created with the song loaded.
    //************************************************************
    ...
    //************************************************************
    // description: Frees the music
    // return: None
    // pre: sound should be defined to music
    // post: frees the music
    //************************************************************
    void free();
};
